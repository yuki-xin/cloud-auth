...
//
//    public UserDetailsServiceImpl(final UserRepository userRepository, final AuthenticationManager
// authenticationManager, final PasswordEncoder passwordEncoder) {
...
//
//            SecurityContextHolder.getContext().setAuthentication(this.createNewAuthentication(currentUser, this
