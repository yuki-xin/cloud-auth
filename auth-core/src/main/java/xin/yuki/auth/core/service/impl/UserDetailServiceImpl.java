...
public class UserDetailServiceImpl implements UserDetailService {
	...
	public UserDetailServiceImpl(final AuthenticationManager authenticationManager,
	                             final PasswordEncoder passwordEncoder, final UserMapper userDao,
	                             final GroupMapper groupDao,
	...
	public UserModel loadUserByUsername(final String username) throws UsernameNotFoundException {
		return this.userDao.findOneByUsernameAndEnabled(username, true);
	}
